...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		}`};const eE=new $w().load("./star.png"),tE=[new Ee(16777215),new Ee(16751103),new Ee(10092543),new Ee(16777113),new Ee(16751001),new Ee(10092441),new Ee(10066431)];class nE{constructor(e=0,t=new I(0,0,0),i=new I(1,1,1)){this.object=new ct,this.stars=Array(e);for(let r=0;r<this.stars.length;r++){let s=new I(Wr.randFloat(t.x,i.x),Wr.randFloat(t.y,i.y),Wr.randFloat(t.z,i.z)),o=tE[Wr.randInt(0,6)],a=Wr.randInt(1,3);this.stars[r]=new iE(s,o,a),this.object.add(this.stars[r].starSprite)}}update(e){for(let t=0;t<this.stars.length;t++)this.stars[t].update(e)}}class iE{constructor(e=new I,t=new Ee,i=1){this.updateRate=i,this.starMat=new i0({map:eE,color:t.getHex()}),this.starSprite=new Vw(this.starMat),this.animationState=Wr.randFloat(0,Math.PI/2),this.scale=Math.sin(this.animationState)/2+.5,this.starSprite.scale.set(this.scale,this.scale,1),this.starSprite.position.set(e.x,e.y,e.z)}update(e){this.animationState+=Math.PI/2*this.updateRate*e,this.animationState%=Math.PI*2,this.scale=Math.sin(this.animationState)/2+.5,this.starSprite.scale.set(this.scale,this.scale,1)}}var Wf={exports:{}},Dl={};/**
 * @license React
